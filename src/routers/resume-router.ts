...
class ResumeRouter {
    ...
    routes() {
        ...
        this.router.post('/add/reference/:id', auth, ResumeController.addRefrences);
        ...
        this.router.patch('/update/reference/:id', auth, ResumeController.updateRefrence);
        ...
        this.router.delete('/delete/reference/:id', auth, ResumeController.deleteRefrence);
